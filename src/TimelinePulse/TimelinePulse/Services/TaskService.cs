...
namespace TimelinePulse.Services
{
    public class TaskService
    {
        ...
        public List<Models.Task> GetTasks()
        {
            ...
            {
                new Models.Task { Name = "Customer meeting", Category = "Hangouts", Status = "Warning", Time = "6pm", Color = Color.FromHex("#EEB611"), People = new List<Models.Person> { new Models.Person { Photo = "TimelinePulse.Resources.face2.jpg" }, new Models.Person { Photo = "TimelinePulse.Resources.face5.jpg" } }, Completed = false },
